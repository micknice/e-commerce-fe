...
const Cart = () => {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 px-4 gap-x-4 ">
            <div className="flex flex-col pb-4 gap-y-4">
                ...
                <div className='w-full flex flex-col items-center justify-center gap-y-2 '>
                    ...
                    <div className='bg-mira-headtext flex items-center justify-center h-8 px-3 select-none hover:bg-mira-orange' onClick={handleClearBasket}>
                        <p className='text-white text-sm font-light tracking-wide'>Clear Shopping Cart</p>
                    </div>
                    <div className='bg-mira-headtext flex flex-row items-center justify-center h-8 px-3 text-white gap-x-4 select-none hover:bg-mira-orange'>
                        <HiRefresh/>
            ...
            <div className='h-auto w-full flex flex-col gap-y-4 pt-[128px] '>
