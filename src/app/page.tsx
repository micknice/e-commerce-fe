    ...
    <div className=' w-full bg-white flex flex-col'>
      ...
      <div className=' flex flex-col px-4 pt-2 bg-white'>
        ...
        <div className=' grid grid-cols-2 gap-x-2 gap-y-5 pt-6 md:grid-cols-4'>
          {/* big item card */}
          <BigItemCard subCategory={'weight-benches'}/>
          <BigItemCard subCategory={'weights-and-bars'}/>
          <BigItemCard subCategory={'power-cages-racks'}/>
          <BigItemCard subCategory={'kettlebells'}/>
          <BigItemCard subCategory={'medicine-balls'}/>
          <BigItemCard subCategory={'squat-racks-stands'}/>
          <BigItemCard subCategory={'pilates-yoga'}/>
          <BigItemCard subCategory={'boxing-equipment'}/>
        </div>
